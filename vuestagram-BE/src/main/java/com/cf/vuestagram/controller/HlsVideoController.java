...
// private final String UPLOAD_DIR = "업로드 경로";

// @GetMapping("/hls-make/{fileName}")
// @ResponseBody
// public void videoHlsMake(@PathVariable String fileName, Model model) throws
// IOException {
// log.debug("************** class = {}, function = {}",
// this.getClass().getName(), new Object() {
...
// final String ONLY_FILENAME = fileName.substring(0,
...
// // 이미지 파일 생성
// FFmpegBuilder builderThumbNail = new
// FFmpegBuilder().overrideOutputFiles(true) // 오버라이드 여부
// .setInput(FILEPATH) // 동영상파일 .addExtraArgs("-ss", "00:00:03") // 썸네일 추출 싲가점
...
// public ResponseEntity<Resource> videoHlsTs(@PathVariable String fileName,
